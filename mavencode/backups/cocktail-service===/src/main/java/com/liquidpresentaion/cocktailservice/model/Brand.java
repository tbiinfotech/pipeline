...
//	private int supplierGroupId;
	...
	public Brand(int id, String name, Group supplierGroup, BaseSpiritCategory baseSpiritCategory, String defaultImage, Date createDate, Category brCategory) {
		this.id = id;
		this.name = name;
		this.supplierGroup = supplierGroup;
		this.baseSpiritCategory = baseSpiritCategory;
	...
	public Brand(int id, String name, Group supplierGroup, BaseSpiritCategory baseSpiritCategory, String defaultImage, Date createDate, Category brCategory,Ingredient ingredient) {
		this.id = id;
		this.name = name;
		this.supplierGroup = supplierGroup;
		this.baseSpiritCategory = baseSpiritCategory;
