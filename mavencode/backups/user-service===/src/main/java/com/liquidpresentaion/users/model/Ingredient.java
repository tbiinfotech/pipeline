...
public class Ingredient  {
	...
	public Integer getInBrandPkid() {
		return this.inBrandPkid;
	}

	public void setInBrandPkid(Integer inBrandPkid) {
	...
	public String getInRawsize() {
		return  (this.inSize == null || this.inUom == null) ? "" : (this.inSize + " " + this.inUom);
	}
